...
import {CarFront, LayoutDashboard, MessageCircle} from "lucide-react";


const Links =() =>{
    return <ul className={'flex items-center gap-4'}>
        <li title={'Dashboard'}><Link href={'/riders'} className={'h-[30px] w-[30px] hover:bg-[#f1f1f1] flex items-center justify-center rounded-full'}><LayoutDashboard size={18}/></Link></li>
        ...
        <li title={'Logout'}><Button variant={'ghost'} onClick={e => signOut()}>Logout</Button></li>
    </ul>
}
