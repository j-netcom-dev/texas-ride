...
const Success = () => {
  ...
  useEffect(() =>{
    const { data } =get_user_details(2) as UserData || undefined; 
    if(!data) return;
  ...
  return (
    <div className="bg-white px-8 py-16 relative w-[400px] max-w-full flex flex-col gap-8 items-center shadow rounded-xl">
        ...
        <p className='text-center'>Your account was created successfully. Please check your email <b>{email}</b> for further instructions.</p>
